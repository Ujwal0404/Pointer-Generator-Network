...
all_train_urls = "url_lists/cnn_wayback_training_urls.txt"
all_val_urls = "url_lists/cnn_wayback_validation_urls.txt"
all_test_urls = "url_lists/cnn_wayback_test_urls.txt"
